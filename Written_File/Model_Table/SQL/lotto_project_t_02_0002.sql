...
--
-- Table structure for table `t_02_0002`
--

DROP TABLE IF EXISTS `t_02_0002`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_02_0002` (
  `t_uuid_1` varchar(36) NOT NULL,
  `t_uuid_2` varchar(36) DEFAULT NULL,
  `select_number_1` varchar(45) DEFAULT NULL,
...
--
-- Dumping data for table `t_02_0002`
--

LOCK TABLES `t_02_0002` WRITE;
/*!40000 ALTER TABLE `t_02_0002` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_02_0002` ENABLE KEYS */;
UNLOCK TABLES;
